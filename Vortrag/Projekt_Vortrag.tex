%Time-stamp: <2016-03-15 07:32:31 renke>
...
\date[11.01.2016]{11. Januar 2016}
...
% Pappel, Acker, waagerechte Linien, senkrechte Linien
      \visible<\thesecondElement->{\draw[green] (0.5,1.5) node{\tiny Pappel};}
      \visible<\thesecondElement->{\draw[brown] (4.5,1.5) node{\tiny Acker};}
% senkrechte Linien (Pappel, Acker)
      \visible<\thesecondElement->{\draw[green] (0,1.2) -- (0,1.5);}
      % \visible<\thesecondElement->{\draw[green] (2.49,1.2) -- (2.49,1.5);}
      % \visible<\thesecondElement->{\draw[brown] (2.5,1.2) -- (2.5,1.5);}
      \visible<\thesecondElement->{\draw[brown] (5,1.2) -- (5,1.5);}
% waagerechte Linien (Pappel, Acker)
      \visible<\thesecondElement->{\draw[green] (0,1.35) -- (3.5,1.35);}
      \visible<\thesecondElement->{\draw[brown,dashed] (1.5,1.35) -- (3.5,1.35);}
      \visible<\thesecondElement->{\draw[brown] (3.5,1.35) -- (5,1.35);}
% tn
      \visible<\thethirdElement->{\draw (-2,0) node{\tiny$t_n$};}
% waagerechte Linien (tn)
      \visible<\thefirstElement->{\draw[gray,thin] (0,0) -- (2.25,0);}
      \visible<\thefirstElement->{\draw[gray,thin] (3.75,0) -- (5,0);}
% Auslassungspunkte (tn)
      \visible<\thefirstElement->{\draw (3,0) node{\ldots};}
% i =
      \visible<\thesecondElement-\thefifthElement>{\draw (-0.5,-0.5) node{\tiny$i =$};}
% senkrechte Linien an Knoten, Knoten, Knotennummern (tn)
      \foreach \xcoord in {0,1,2}
      {
        \visible<\thefirstElement->{\draw[gray,thin] (\xcoord,0.25) -- (\xcoord,-0.25);}
        \visible<\thefirstElement->{\fill[black] (\xcoord,0) circle (0.75mm);}
        \visible<\thesecondElement-\thefifthElement>{\draw (\xcoord,-0.5) node{\tiny$\xcoord$};}
      }
      \foreach \xcoord in {4,5}
      {
        \visible<\thefirstElement->{\draw[gray,thin] (\xcoord,0.25) -- (\xcoord,-0.25);}
        \visible<\thefirstElement->{\fill[black] (\xcoord,0) circle (0.75mm);}
      }
      \visible<\thesecondElement-\thefifthElement>{\draw (4,-0.5) node{\tiny$x-1$};}
      \visible<\thesecondElement-\thefifthElement>{\draw (5,-0.5) node{\tiny$x$};}
% senkrechte Linien für K (tn)
      \foreach \xcoord in {0.5,1.5}
      {
        \visible<\thefirstElement->{\draw[black,thin] (\xcoord,0.05) -- (\xcoord,-0.05);}
      }
      \visible<\thefirstElement->{\draw[black,thin] (4.5,0.05) -- (4.5,-0.05);}
% waagerechte Linien (m=1)
      \visible<\theseventhElement->{\draw[gray,thin] (0,-0.75) -- (2.25,-0.75);}
      \visible<\theseventhElement->{\draw[gray,thin] (3.75,-0.75) -- (5,-0.75);}
% Auslassungspunkte (m=1)
      \visible<\theseventhElement->{\draw (3,-0.75) node{\ldots};}
% senkrechte Linien an Knoten, Knoten (m=1)
      \foreach \xcoord in {0,1,2}
      {
        \visible<\theseventhElement->{\draw[gray,thin] (\xcoord,-0.5) -- (\xcoord,-1);}
        \visible<\theseventhElement->{\fill[black] (\xcoord,-0.75) circle (0.75mm);}
      }
      \foreach \xcoord in {4,5}
      {
        \visible<\theseventhElement->{\draw[gray,thin] (\xcoord,-0.5) -- (\xcoord,-1);}
...
% senkrechte Linien für K (m=1)
      \foreach \xcoord in {0.5,1.5}
      {
        \visible<\theseventhElement->{\draw[black,thin] (\xcoord,-0.7) -- (\xcoord,-0.8);}
      }
      \visible<\theseventhElement->{\draw[black,thin] (4.5,-0.7) -- (4.5,-0.8);}
% waagerechte Linien (m=2)
      \visible<\theseventhElement->{\draw[gray,thin] (0,-1.5) -- (2.25,-1.5);}
      \visible<\theseventhElement->{\draw[gray,thin] (3.75,-1.5) -- (5,-1.5);}
% Auslassungspunkte (m=2)
      \visible<\theseventhElement->{\draw (3,-1.5) node{\ldots};}
% senkrechte Linien an Knoten, Knoten (m=2)
      \foreach \xcoord in {0,1,2}
      {
        \visible<\theseventhElement->{\draw[gray,thin] (\xcoord,-1.25) -- (\xcoord,-1.75);}
        \visible<\theseventhElement->{\fill[black] (\xcoord,-1.5) circle (0.75mm);}
      }
      \foreach \xcoord in {4,5}
      {
        \visible<\theseventhElement->{\draw[gray,thin] (\xcoord,-1.25) -- (\xcoord,-1.75);}
...
% senkrechte Linien für K (m=2)
      \foreach \xcoord in {0.5,1.5}
      {
        \visible<\theseventhElement->{\draw[black,thin] (\xcoord,-1.45) -- (\xcoord,-1.55);}
      }
      \visible<\theseventhElement->{\draw[black,thin] (4.5,-1.45) -- (4.5,-1.55);}
% geschwungene Klammer (tn)
      \visible<\thesecondElement->{\draw[decorate,decoration=brace] (0,0.25) -- (1,0.25);}
% Delta z
      \visible<\thesecondElement->{\draw (0.5,0.5) node{\tiny$\Delta z$};}
% Pfeil, Delta t
      \visible<\thefourthElement->{\draw[->] (-2,-0.5) -- (-2,-2.5);}
      \visible<\thefourthElement-\thefifthElement>{\draw (-1.75,-1.5) node{\tiny$\Delta t$};}
% m=1
      \visible<\theseventhElement>{\draw (-1.5,-0.75) node{\tiny$m = 1$};}
% m=2
      \visible<\theseventhElement>{\draw (-1.5,-1.5) node{\tiny$m = 2$};}
% Auslassungspunkte für m=3
      \visible<\theseventhElement>{\draw (-1.5,-2) node{\tiny\ldots};}
% tn+1
      \visible<\thefifthElement->{\draw (-2,-3) node{\tiny$t_{n+1}$};}
% waagerechte Linien (tn+1)
      \visible<\thefifthElement->{\draw[gray,thin] (0,-3) -- (2.75,-3);}
      \visible<\thefifthElement->{\draw[gray,thin] (3.25,-3) -- (5,-3);}
% Auslassungspunkte (tn+1)
      \visible<\thefifthElement->{\draw (3,-3) node{\ldots};}
% senkrechte Linien, Knoten (tn+1)
      \foreach \xcoord in {0,1,2}
      {
        \visible<\thefifthElement->{\draw[gray,thin] (\xcoord,-2.75) -- (\xcoord,-3.25);}
        \visible<\thefifthElement->{\fill[black] (\xcoord,-3) circle (0.75mm);}
      }
      \foreach \xcoord in {4,5}
      {
        \visible<\thefifthElement->{\draw[gray,thin] (\xcoord,-2.75) -- (\xcoord,-3.25);}
...
% senkrechte Linien für K, Nummern für K (tn+1)
      \foreach \xcoord in {0.5,1.5}
      {
        \visible<\thefifthElement->{\draw[black,thin] (\xcoord,-2.95) -- (\xcoord,-3.05);}
      }
      \visible<\thefifthElement->{\draw[black,thin] (4.5,-2.95) -- (4.5,-3.05);}
    \end{tikzpicture}}
  % }
